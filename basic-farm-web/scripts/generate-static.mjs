...
async function main() {
  ...
  writeFile(
    "index.html",
    `<!doctype html><html><head><meta charset="UTF-8"><meta http-equiv="refresh" content="0; url=${BASE_PATH}/en/index.html"><title>Basic Farm</title></head><body></body></html>`,
    { indexable: false }
  );

  writeFile("404.html", notFoundPage({}, "Basic Farm"), { indexable: false });
